...
```shell
nmap -T4 -A 10.10.25.163

gobuster dir -u http://10.10.25.163 -w /usr/share/dirbuster/wordlists/directory-list-2.3-medium.txt

gobuster dir -u http://10.10.25.163 -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -s 204,301,302,307,401,403
...
Checking <http://10.10.25.163>, we get an Admin Dashboard with various tabs.
