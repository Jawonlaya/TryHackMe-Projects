...
```shell
rustscan -a 10.10.141.61 --range 0-65535 --ulimit 5000 -- -sV

ftp 10.10.141.61
#anonymous login not allowed

feroxbuster -u http://10.10.141.61 -w /usr/share/wordlists/dirb/common.txt -x php,html,bak,js,txt,json,docx,pdf,zip --extract-links --scan-limit 2 --filter-status 401,403,404,405,500 --silent
