...
```shell
rustscan -a 10.10.33.66 --range 0-65535 --ulimit 5000 -- -sV
```
...
```shell
feroxbuster -u http://10.10.33.66 -w /usr/share/wordlists/dirb/common.txt -x php,html,bak,js,txt,json,docx,pdf --extract-links --scan-limit 2 --filter-status 401,403,404,405,500
...
feroxbuster -u http://10.10.33.66/d1r3c70ry_center -w /usr/share/wordlists/dirb/common.txt -x php,html,bak,js,txt,json,docx,pdf --extract-links --scan-limit 2 --filter-status 401,403,404,405,500

feroxbuster -u http://10.10.33.66/d1r3c70ry_center/ -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -x php,html,bak,js,txt,json,docx,pdf --extract-links --scan-limit 2 --filter-status 401,403,404,405,500 --silent
